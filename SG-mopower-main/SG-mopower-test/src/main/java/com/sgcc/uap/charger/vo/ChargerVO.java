...
public class ChargerVO extends ParentVO implements Serializable{
     ...
     * 属性chargerCapacity
     */  
    @ViewAttribute(name ="chargercapacity",caption="chargerCapacity", editor=EditorType.NumberEditor,nullable =true,readOnly=false, type=AttributeType.FLOAT)
     ...
     * @param string
     */
    public void setChargercapacity(String string){
		this.chargercapacity = string;
	} 
    /**
     * batteryType的get方法
     * @return batterytype
